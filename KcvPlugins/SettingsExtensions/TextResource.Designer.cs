...
namespace AMing.SettingsExtensions {
    ...
    public class TextResource {
        ...
        /// <summary>
        ///   查找类似 只在幽灵模式下启用透明度 的本地化字符串。
        /// </summary>
        public static string GhostEnableOpacity {
            get {
                return ResourceManager.GetString("GhostEnableOpacity", resourceCulture);
            }
        }
        ...
        ///   查找类似 迷你舰队信息 的本地化字符串。
        /// </summary>
        public static string SimpleFleetWindow_Title {
            get {
                return ResourceManager.GetString("SimpleFleetWindow_Title", resourceCulture);
            }
        }
